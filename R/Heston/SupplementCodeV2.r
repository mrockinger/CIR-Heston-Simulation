...
# Abstract: 
# We focus on returns defned as log-price differentials and generated by a diffusion process with stochastic volatility and jumps in prices.
...
MomentsCIR = function(p, q = 0, kappa, theta, sigma, v0, t, conditional = TRUE, comoments = FALSE){
...
MomentsBates = function(mu, kappa, theta, sigma, rho, lambda, muj, vj, t, v0, conditional = TRUE){
...
MomentsCIR(p = 1:4, kappa = 3, theta = 0.19, sigma = 0.4, v0 = 0.1, t = 1/250, conditional = F)
...
MomentsCIR(p = 1:4, q = 1:4, kappa = 3, theta = 0.19, sigma = 0.4, v0 = 0.1, t = 1/250, conditional = F, comoments = T)

# Compute first four conditional moments as well as skewness and kurtosis for 1-day log-returns
...
MomentsBates(mu = 0, kappa = 3, theta = 0.19, sigma = 0.4, rho = -0.7, lambda = 20, muj = 0, vj = 0.1, t = 1/250, v0 = 0.1, conditional = F)
